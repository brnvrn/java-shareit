...
public class ItemRequestController {
    ...
    @PostMapping
    public ItemRequestDto addNewItemRequest(@RequestHeader(USER_HEADER) Long userId,
    ...
    @GetMapping
    public List<ItemRequestResponseDto> getItemRequestByUser(@RequestHeader(USER_HEADER) Long userId) {
    ...
    public ItemRequestResponseDto getItemRequest(@RequestHeader(USER_HEADER) Long userId,
    ...
    @GetMapping("/all")
    public List<ItemRequestDto> getAllItemRequests(@RequestHeader(USER_HEADER) Long userId,
